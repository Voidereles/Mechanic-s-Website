...
--
-- Host: 127.0.0.1
-- Czas generowania: 26 Lut 2019, 18:48
...
(1, 'AJK78', 'DHA37', 537381922, 'Passat B6 kombi czarny', 'Uszczelka pod gÅ‚owicÄ…', 'Uszczelka wymieniona, silnik wyczyszczony', 2000, 'Odebrany'),
(2, 'AJK78', 'DHA38', 537381922, 'Passat B5 kombi srebrny', 'Hamulce w zÅ‚ym stanie', 'Wymiana tarcz hamulcowych', 280, 'Czeka na czÄ™Å›ci'),
(4, 'J31BN', 'JDKA1', 232934672, 'Citroen C5 III Sedan brÄ…zowy', 'Zawieszenie pneumatyczne nie dziaÅ‚a', 'Zawieszenie wymienione na nowe', 5000, 'Czeka na odbiÃ³r');
